...
export default async function decorate(block) {
  ...
  if (loginLink) {
    ...
    // Red padlock icon before the label, matching loves.com. Inline SVG keeps
    // the header self-contained (no icon-font dependency).
    a.innerHTML = '<svg class="nav-login-icon" aria-hidden="true" viewBox="0 0 448 512" width="14" height="16">'
      + '<path fill="currentColor" d="M144 144v48h160v-48c0-44.2-35.8-80-80-80s-80 35.8-80 80zM80 192v-48C80 64.5 144.5 0 224 0s144 64.5 144 144v48h16c35.3 0 64 28.7 64 64v192c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V256c0-35.3 28.7-64 64-64h16z"/>'
      + '</svg>';
    a.appendChild(document.createTextNode(loginLink.textContent.trim()));
    tools.appendChild(a);
  }
